...
function LegalSection({ section }) {
  return (
    <div>
      ...
      {section.afterList && (
        <p className="mb-4 font-poppins text-[16px] leading-relaxed text-text-muted">
          {section.afterList}
        </p>
      )}
    </div>
  ...
  return (
    <main className="w-full">
      ...
      <div className="mx-auto max-w-4xl px-8 py-16">
        <h2 className="mb-2 font-poppins text-[28px] font-bold text-text-primary">Terms of use</h2>
        ...
        <p className="mb-6 font-poppins text-[16px] leading-relaxed text-text-muted">
